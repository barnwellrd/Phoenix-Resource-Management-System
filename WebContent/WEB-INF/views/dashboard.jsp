				...
				<span id="linkside">
					...
					<div class="panel-group">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							id="burger" style="font-color: white;" data-toggle="dropdown"><span
								class="glyphicon glyphicon-menu-hamburger"
								style="font-size: 50px; text-align: center; color: white;"></span></a>
							<ul class="dropdown-menu">

								<li><a href="#">Book <span
										class="glyphicon glyphicon-book pull-right"></span></a></li>
								<li class="divider"></li>

								<li><a href="#">Upcoming <span
										class="glyphicon glyphicon-folder-open pull-right"></span></a></li>
								<li class="divider"></li>

								<li><a href="#">Previous <span
										class="glyphicon glyphicon-retweet pull-right"></span></a></li>
								<li class="divider"></li>
								...
								<li class="divider"></li>
								<li><a href="#"><span
										class="glyphicon glyphicon-remove pull-right"></span>Cancel </a></li>
							</ul></li>
